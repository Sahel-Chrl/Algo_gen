...
Nous pouvons par exemple observer plus en détail mon premier AG : « AG-polynomes », codé [ici](mes-AG/Paysage/Polynomes/AG-polynomes.pde)  en Processing et [ici](mes-AG/Paysage/Polynomes/AG-polynomes.cpp) en C++. 
