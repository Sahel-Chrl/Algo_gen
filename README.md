...
Nous pouvons par exemple observer plus en détail mon premier AG : « AG-polynomes », codé [ici](mes-AG/Polynomes/Polynomes.pde)  en Processing et [ici](mes-AG/Polynomes/AG-polynomes.cpp) en C++. 
